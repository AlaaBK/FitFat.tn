...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder2103e = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializerd278a = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5009f = [
        
    ];

    public function getConnection()
    {
        $this->initializerd278a && ($this->initializerd278a->__invoke($valueHolder2103e, $this, 'getConnection', array(), $this->initializerd278a) || 1) && $this->valueHolder2103e = $valueHolder2103e;

        return $this->valueHolder2103e->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializerd278a && ($this->initializerd278a->__invoke($valueHolder2103e, $this, 'getMetadataFactory', array(), $this->initializerd278a) || 1) && $this->valueHolder2103e = $valueHolder2103e;

        return $this->valueHolder2103e->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializerd278a && ($this->initializerd278a->__invoke($valueHolder2103e, $this, 'getExpressionBuilder', array(), $this->initializerd278a) || 1) && $this->valueHolder2103e = $valueHolder2103e;

        return $this->valueHolder2103e->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializerd278a && ($this->initializerd278a->__invoke($valueHolder2103e, $this, 'beginTransaction', array(), $this->initializerd278a) || 1) && $this->valueHolder2103e = $valueHolder2103e;

        return $this->valueHolder2103e->beginTransaction();
    }

    public function getCache()
    {
        $this->initializerd278a && ($this->initializerd278a->__invoke($valueHolder2103e, $this, 'getCache', array(), $this->initializerd278a) || 1) && $this->valueHolder2103e = $valueHolder2103e;

        return $this->valueHolder2103e->getCache();
    }

    public function transactional($func)
    {
        $this->initializerd278a && ($this->initializerd278a->__invoke($valueHolder2103e, $this, 'transactional', array('func' => $func), $this->initializerd278a) || 1) && $this->valueHolder2103e = $valueHolder2103e;

        return $this->valueHolder2103e->transactional($func);
    }

    public function commit()
    {
        $this->initializerd278a && ($this->initializerd278a->__invoke($valueHolder2103e, $this, 'commit', array(), $this->initializerd278a) || 1) && $this->valueHolder2103e = $valueHolder2103e;

        return $this->valueHolder2103e->commit();
    }

    public function rollback()
    {
        $this->initializerd278a && ($this->initializerd278a->__invoke($valueHolder2103e, $this, 'rollback', array(), $this->initializerd278a) || 1) && $this->valueHolder2103e = $valueHolder2103e;

        return $this->valueHolder2103e->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializerd278a && ($this->initializerd278a->__invoke($valueHolder2103e, $this, 'getClassMetadata', array('className' => $className), $this->initializerd278a) || 1) && $this->valueHolder2103e = $valueHolder2103e;

        return $this->valueHolder2103e->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializerd278a && ($this->initializerd278a->__invoke($valueHolder2103e, $this, 'createQuery', array('dql' => $dql), $this->initializerd278a) || 1) && $this->valueHolder2103e = $valueHolder2103e;

        return $this->valueHolder2103e->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializerd278a && ($this->initializerd278a->__invoke($valueHolder2103e, $this, 'createNamedQuery', array('name' => $name), $this->initializerd278a) || 1) && $this->valueHolder2103e = $valueHolder2103e;

        return $this->valueHolder2103e->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializerd278a && ($this->initializerd278a->__invoke($valueHolder2103e, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializerd278a) || 1) && $this->valueHolder2103e = $valueHolder2103e;

        return $this->valueHolder2103e->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializerd278a && ($this->initializerd278a->__invoke($valueHolder2103e, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializerd278a) || 1) && $this->valueHolder2103e = $valueHolder2103e;

        return $this->valueHolder2103e->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializerd278a && ($this->initializerd278a->__invoke($valueHolder2103e, $this, 'createQueryBuilder', array(), $this->initializerd278a) || 1) && $this->valueHolder2103e = $valueHolder2103e;

        return $this->valueHolder2103e->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializerd278a && ($this->initializerd278a->__invoke($valueHolder2103e, $this, 'flush', array('entity' => $entity), $this->initializerd278a) || 1) && $this->valueHolder2103e = $valueHolder2103e;

        return $this->valueHolder2103e->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializerd278a && ($this->initializerd278a->__invoke($valueHolder2103e, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerd278a) || 1) && $this->valueHolder2103e = $valueHolder2103e;

        return $this->valueHolder2103e->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializerd278a && ($this->initializerd278a->__invoke($valueHolder2103e, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializerd278a) || 1) && $this->valueHolder2103e = $valueHolder2103e;

        return $this->valueHolder2103e->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializerd278a && ($this->initializerd278a->__invoke($valueHolder2103e, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializerd278a) || 1) && $this->valueHolder2103e = $valueHolder2103e;

        return $this->valueHolder2103e->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializerd278a && ($this->initializerd278a->__invoke($valueHolder2103e, $this, 'clear', array('entityName' => $entityName), $this->initializerd278a) || 1) && $this->valueHolder2103e = $valueHolder2103e;

        return $this->valueHolder2103e->clear($entityName);
    }

    public function close()
    {
        $this->initializerd278a && ($this->initializerd278a->__invoke($valueHolder2103e, $this, 'close', array(), $this->initializerd278a) || 1) && $this->valueHolder2103e = $valueHolder2103e;

        return $this->valueHolder2103e->close();
    }

    public function persist($entity)
    {
        $this->initializerd278a && ($this->initializerd278a->__invoke($valueHolder2103e, $this, 'persist', array('entity' => $entity), $this->initializerd278a) || 1) && $this->valueHolder2103e = $valueHolder2103e;

        return $this->valueHolder2103e->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializerd278a && ($this->initializerd278a->__invoke($valueHolder2103e, $this, 'remove', array('entity' => $entity), $this->initializerd278a) || 1) && $this->valueHolder2103e = $valueHolder2103e;

        return $this->valueHolder2103e->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializerd278a && ($this->initializerd278a->__invoke($valueHolder2103e, $this, 'refresh', array('entity' => $entity), $this->initializerd278a) || 1) && $this->valueHolder2103e = $valueHolder2103e;

        return $this->valueHolder2103e->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializerd278a && ($this->initializerd278a->__invoke($valueHolder2103e, $this, 'detach', array('entity' => $entity), $this->initializerd278a) || 1) && $this->valueHolder2103e = $valueHolder2103e;

        return $this->valueHolder2103e->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializerd278a && ($this->initializerd278a->__invoke($valueHolder2103e, $this, 'merge', array('entity' => $entity), $this->initializerd278a) || 1) && $this->valueHolder2103e = $valueHolder2103e;

        return $this->valueHolder2103e->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializerd278a && ($this->initializerd278a->__invoke($valueHolder2103e, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializerd278a) || 1) && $this->valueHolder2103e = $valueHolder2103e;

        return $this->valueHolder2103e->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializerd278a && ($this->initializerd278a->__invoke($valueHolder2103e, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerd278a) || 1) && $this->valueHolder2103e = $valueHolder2103e;

        return $this->valueHolder2103e->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializerd278a && ($this->initializerd278a->__invoke($valueHolder2103e, $this, 'getRepository', array('entityName' => $entityName), $this->initializerd278a) || 1) && $this->valueHolder2103e = $valueHolder2103e;

        return $this->valueHolder2103e->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializerd278a && ($this->initializerd278a->__invoke($valueHolder2103e, $this, 'contains', array('entity' => $entity), $this->initializerd278a) || 1) && $this->valueHolder2103e = $valueHolder2103e;

        return $this->valueHolder2103e->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializerd278a && ($this->initializerd278a->__invoke($valueHolder2103e, $this, 'getEventManager', array(), $this->initializerd278a) || 1) && $this->valueHolder2103e = $valueHolder2103e;

        return $this->valueHolder2103e->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializerd278a && ($this->initializerd278a->__invoke($valueHolder2103e, $this, 'getConfiguration', array(), $this->initializerd278a) || 1) && $this->valueHolder2103e = $valueHolder2103e;

        return $this->valueHolder2103e->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializerd278a && ($this->initializerd278a->__invoke($valueHolder2103e, $this, 'isOpen', array(), $this->initializerd278a) || 1) && $this->valueHolder2103e = $valueHolder2103e;

        return $this->valueHolder2103e->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializerd278a && ($this->initializerd278a->__invoke($valueHolder2103e, $this, 'getUnitOfWork', array(), $this->initializerd278a) || 1) && $this->valueHolder2103e = $valueHolder2103e;

        return $this->valueHolder2103e->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializerd278a && ($this->initializerd278a->__invoke($valueHolder2103e, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializerd278a) || 1) && $this->valueHolder2103e = $valueHolder2103e;

        return $this->valueHolder2103e->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializerd278a && ($this->initializerd278a->__invoke($valueHolder2103e, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializerd278a) || 1) && $this->valueHolder2103e = $valueHolder2103e;

        return $this->valueHolder2103e->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializerd278a && ($this->initializerd278a->__invoke($valueHolder2103e, $this, 'getProxyFactory', array(), $this->initializerd278a) || 1) && $this->valueHolder2103e = $valueHolder2103e;

        return $this->valueHolder2103e->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializerd278a && ($this->initializerd278a->__invoke($valueHolder2103e, $this, 'initializeObject', array('obj' => $obj), $this->initializerd278a) || 1) && $this->valueHolder2103e = $valueHolder2103e;

        return $this->valueHolder2103e->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializerd278a && ($this->initializerd278a->__invoke($valueHolder2103e, $this, 'getFilters', array(), $this->initializerd278a) || 1) && $this->valueHolder2103e = $valueHolder2103e;

        return $this->valueHolder2103e->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializerd278a && ($this->initializerd278a->__invoke($valueHolder2103e, $this, 'isFiltersStateClean', array(), $this->initializerd278a) || 1) && $this->valueHolder2103e = $valueHolder2103e;

        return $this->valueHolder2103e->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializerd278a && ($this->initializerd278a->__invoke($valueHolder2103e, $this, 'hasFilters', array(), $this->initializerd278a) || 1) && $this->valueHolder2103e = $valueHolder2103e;

        return $this->valueHolder2103e->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializerd278a = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder2103e) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder2103e = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder2103e->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializerd278a && ($this->initializerd278a->__invoke($valueHolder2103e, $this, '__get', ['name' => $name], $this->initializerd278a) || 1) && $this->valueHolder2103e = $valueHolder2103e;

        if (isset(self::$publicProperties5009f[$name])) {
            return $this->valueHolder2103e->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder2103e;
    ...
    {
        $this->initializerd278a && ($this->initializerd278a->__invoke($valueHolder2103e, $this, '__set', array('name' => $name, 'value' => $value), $this->initializerd278a) || 1) && $this->valueHolder2103e = $valueHolder2103e;
    ...
    {
        $this->initializerd278a && ($this->initializerd278a->__invoke($valueHolder2103e, $this, '__isset', array('name' => $name), $this->initializerd278a) || 1) && $this->valueHolder2103e = $valueHolder2103e;
    ...
    {
        $this->initializerd278a && ($this->initializerd278a->__invoke($valueHolder2103e, $this, '__unset', array('name' => $name), $this->initializerd278a) || 1) && $this->valueHolder2103e = $valueHolder2103e;
    ...
    {
        $this->initializerd278a && ($this->initializerd278a->__invoke($valueHolder2103e, $this, '__clone', array(), $this->initializerd278a) || 1) && $this->valueHolder2103e = $valueHolder2103e;

        $this->valueHolder2103e = clone $this->valueHolder2103e;
    }

    public function __sleep()
    {
        $this->initializerd278a && ($this->initializerd278a->__invoke($valueHolder2103e, $this, '__sleep', array(), $this->initializerd278a) || 1) && $this->valueHolder2103e = $valueHolder2103e;

        return array('valueHolder2103e');
    }
    ...
    {
        $this->initializerd278a = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializerd278a;
    }

    public function initializeProxy() : bool
    {
        return $this->initializerd278a && ($this->initializerd278a->__invoke($valueHolder2103e, $this, 'initializeProxy', array(), $this->initializerd278a) || 1) && $this->valueHolder2103e = $valueHolder2103e;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder2103e;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder2103e;
    }
}
