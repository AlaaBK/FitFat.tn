...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHoldercf392 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer0994f = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicPropertiesd51db = [
        
    ];

    public function getConnection()
    {
        $this->initializer0994f && ($this->initializer0994f->__invoke($valueHoldercf392, $this, 'getConnection', array(), $this->initializer0994f) || 1) && $this->valueHoldercf392 = $valueHoldercf392;

        return $this->valueHoldercf392->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer0994f && ($this->initializer0994f->__invoke($valueHoldercf392, $this, 'getMetadataFactory', array(), $this->initializer0994f) || 1) && $this->valueHoldercf392 = $valueHoldercf392;

        return $this->valueHoldercf392->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer0994f && ($this->initializer0994f->__invoke($valueHoldercf392, $this, 'getExpressionBuilder', array(), $this->initializer0994f) || 1) && $this->valueHoldercf392 = $valueHoldercf392;

        return $this->valueHoldercf392->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer0994f && ($this->initializer0994f->__invoke($valueHoldercf392, $this, 'beginTransaction', array(), $this->initializer0994f) || 1) && $this->valueHoldercf392 = $valueHoldercf392;

        return $this->valueHoldercf392->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer0994f && ($this->initializer0994f->__invoke($valueHoldercf392, $this, 'getCache', array(), $this->initializer0994f) || 1) && $this->valueHoldercf392 = $valueHoldercf392;

        return $this->valueHoldercf392->getCache();
    }

    public function transactional($func)
    {
        $this->initializer0994f && ($this->initializer0994f->__invoke($valueHoldercf392, $this, 'transactional', array('func' => $func), $this->initializer0994f) || 1) && $this->valueHoldercf392 = $valueHoldercf392;

        return $this->valueHoldercf392->transactional($func);
    }

    public function commit()
    {
        $this->initializer0994f && ($this->initializer0994f->__invoke($valueHoldercf392, $this, 'commit', array(), $this->initializer0994f) || 1) && $this->valueHoldercf392 = $valueHoldercf392;

        return $this->valueHoldercf392->commit();
    }

    public function rollback()
    {
        $this->initializer0994f && ($this->initializer0994f->__invoke($valueHoldercf392, $this, 'rollback', array(), $this->initializer0994f) || 1) && $this->valueHoldercf392 = $valueHoldercf392;

        return $this->valueHoldercf392->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer0994f && ($this->initializer0994f->__invoke($valueHoldercf392, $this, 'getClassMetadata', array('className' => $className), $this->initializer0994f) || 1) && $this->valueHoldercf392 = $valueHoldercf392;

        return $this->valueHoldercf392->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer0994f && ($this->initializer0994f->__invoke($valueHoldercf392, $this, 'createQuery', array('dql' => $dql), $this->initializer0994f) || 1) && $this->valueHoldercf392 = $valueHoldercf392;

        return $this->valueHoldercf392->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer0994f && ($this->initializer0994f->__invoke($valueHoldercf392, $this, 'createNamedQuery', array('name' => $name), $this->initializer0994f) || 1) && $this->valueHoldercf392 = $valueHoldercf392;

        return $this->valueHoldercf392->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer0994f && ($this->initializer0994f->__invoke($valueHoldercf392, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer0994f) || 1) && $this->valueHoldercf392 = $valueHoldercf392;

        return $this->valueHoldercf392->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer0994f && ($this->initializer0994f->__invoke($valueHoldercf392, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer0994f) || 1) && $this->valueHoldercf392 = $valueHoldercf392;

        return $this->valueHoldercf392->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer0994f && ($this->initializer0994f->__invoke($valueHoldercf392, $this, 'createQueryBuilder', array(), $this->initializer0994f) || 1) && $this->valueHoldercf392 = $valueHoldercf392;

        return $this->valueHoldercf392->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer0994f && ($this->initializer0994f->__invoke($valueHoldercf392, $this, 'flush', array('entity' => $entity), $this->initializer0994f) || 1) && $this->valueHoldercf392 = $valueHoldercf392;

        return $this->valueHoldercf392->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer0994f && ($this->initializer0994f->__invoke($valueHoldercf392, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer0994f) || 1) && $this->valueHoldercf392 = $valueHoldercf392;

        return $this->valueHoldercf392->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer0994f && ($this->initializer0994f->__invoke($valueHoldercf392, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer0994f) || 1) && $this->valueHoldercf392 = $valueHoldercf392;

        return $this->valueHoldercf392->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer0994f && ($this->initializer0994f->__invoke($valueHoldercf392, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer0994f) || 1) && $this->valueHoldercf392 = $valueHoldercf392;

        return $this->valueHoldercf392->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer0994f && ($this->initializer0994f->__invoke($valueHoldercf392, $this, 'clear', array('entityName' => $entityName), $this->initializer0994f) || 1) && $this->valueHoldercf392 = $valueHoldercf392;

        return $this->valueHoldercf392->clear($entityName);
    }

    public function close()
    {
        $this->initializer0994f && ($this->initializer0994f->__invoke($valueHoldercf392, $this, 'close', array(), $this->initializer0994f) || 1) && $this->valueHoldercf392 = $valueHoldercf392;

        return $this->valueHoldercf392->close();
    }

    public function persist($entity)
    {
        $this->initializer0994f && ($this->initializer0994f->__invoke($valueHoldercf392, $this, 'persist', array('entity' => $entity), $this->initializer0994f) || 1) && $this->valueHoldercf392 = $valueHoldercf392;

        return $this->valueHoldercf392->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer0994f && ($this->initializer0994f->__invoke($valueHoldercf392, $this, 'remove', array('entity' => $entity), $this->initializer0994f) || 1) && $this->valueHoldercf392 = $valueHoldercf392;

        return $this->valueHoldercf392->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer0994f && ($this->initializer0994f->__invoke($valueHoldercf392, $this, 'refresh', array('entity' => $entity), $this->initializer0994f) || 1) && $this->valueHoldercf392 = $valueHoldercf392;

        return $this->valueHoldercf392->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer0994f && ($this->initializer0994f->__invoke($valueHoldercf392, $this, 'detach', array('entity' => $entity), $this->initializer0994f) || 1) && $this->valueHoldercf392 = $valueHoldercf392;

        return $this->valueHoldercf392->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer0994f && ($this->initializer0994f->__invoke($valueHoldercf392, $this, 'merge', array('entity' => $entity), $this->initializer0994f) || 1) && $this->valueHoldercf392 = $valueHoldercf392;

        return $this->valueHoldercf392->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer0994f && ($this->initializer0994f->__invoke($valueHoldercf392, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer0994f) || 1) && $this->valueHoldercf392 = $valueHoldercf392;

        return $this->valueHoldercf392->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer0994f && ($this->initializer0994f->__invoke($valueHoldercf392, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer0994f) || 1) && $this->valueHoldercf392 = $valueHoldercf392;

        return $this->valueHoldercf392->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer0994f && ($this->initializer0994f->__invoke($valueHoldercf392, $this, 'getRepository', array('entityName' => $entityName), $this->initializer0994f) || 1) && $this->valueHoldercf392 = $valueHoldercf392;

        return $this->valueHoldercf392->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer0994f && ($this->initializer0994f->__invoke($valueHoldercf392, $this, 'contains', array('entity' => $entity), $this->initializer0994f) || 1) && $this->valueHoldercf392 = $valueHoldercf392;

        return $this->valueHoldercf392->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer0994f && ($this->initializer0994f->__invoke($valueHoldercf392, $this, 'getEventManager', array(), $this->initializer0994f) || 1) && $this->valueHoldercf392 = $valueHoldercf392;

        return $this->valueHoldercf392->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer0994f && ($this->initializer0994f->__invoke($valueHoldercf392, $this, 'getConfiguration', array(), $this->initializer0994f) || 1) && $this->valueHoldercf392 = $valueHoldercf392;

        return $this->valueHoldercf392->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer0994f && ($this->initializer0994f->__invoke($valueHoldercf392, $this, 'isOpen', array(), $this->initializer0994f) || 1) && $this->valueHoldercf392 = $valueHoldercf392;

        return $this->valueHoldercf392->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer0994f && ($this->initializer0994f->__invoke($valueHoldercf392, $this, 'getUnitOfWork', array(), $this->initializer0994f) || 1) && $this->valueHoldercf392 = $valueHoldercf392;

        return $this->valueHoldercf392->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer0994f && ($this->initializer0994f->__invoke($valueHoldercf392, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer0994f) || 1) && $this->valueHoldercf392 = $valueHoldercf392;

        return $this->valueHoldercf392->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer0994f && ($this->initializer0994f->__invoke($valueHoldercf392, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer0994f) || 1) && $this->valueHoldercf392 = $valueHoldercf392;

        return $this->valueHoldercf392->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer0994f && ($this->initializer0994f->__invoke($valueHoldercf392, $this, 'getProxyFactory', array(), $this->initializer0994f) || 1) && $this->valueHoldercf392 = $valueHoldercf392;

        return $this->valueHoldercf392->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer0994f && ($this->initializer0994f->__invoke($valueHoldercf392, $this, 'initializeObject', array('obj' => $obj), $this->initializer0994f) || 1) && $this->valueHoldercf392 = $valueHoldercf392;

        return $this->valueHoldercf392->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer0994f && ($this->initializer0994f->__invoke($valueHoldercf392, $this, 'getFilters', array(), $this->initializer0994f) || 1) && $this->valueHoldercf392 = $valueHoldercf392;

        return $this->valueHoldercf392->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer0994f && ($this->initializer0994f->__invoke($valueHoldercf392, $this, 'isFiltersStateClean', array(), $this->initializer0994f) || 1) && $this->valueHoldercf392 = $valueHoldercf392;

        return $this->valueHoldercf392->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer0994f && ($this->initializer0994f->__invoke($valueHoldercf392, $this, 'hasFilters', array(), $this->initializer0994f) || 1) && $this->valueHoldercf392 = $valueHoldercf392;

        return $this->valueHoldercf392->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer0994f = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHoldercf392) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHoldercf392 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHoldercf392->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer0994f && ($this->initializer0994f->__invoke($valueHoldercf392, $this, '__get', ['name' => $name], $this->initializer0994f) || 1) && $this->valueHoldercf392 = $valueHoldercf392;

        if (isset(self::$publicPropertiesd51db[$name])) {
            return $this->valueHoldercf392->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHoldercf392;
    ...
    {
        $this->initializer0994f && ($this->initializer0994f->__invoke($valueHoldercf392, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer0994f) || 1) && $this->valueHoldercf392 = $valueHoldercf392;
    ...
    {
        $this->initializer0994f && ($this->initializer0994f->__invoke($valueHoldercf392, $this, '__isset', array('name' => $name), $this->initializer0994f) || 1) && $this->valueHoldercf392 = $valueHoldercf392;
    ...
    {
        $this->initializer0994f && ($this->initializer0994f->__invoke($valueHoldercf392, $this, '__unset', array('name' => $name), $this->initializer0994f) || 1) && $this->valueHoldercf392 = $valueHoldercf392;
    ...
    {
        $this->initializer0994f && ($this->initializer0994f->__invoke($valueHoldercf392, $this, '__clone', array(), $this->initializer0994f) || 1) && $this->valueHoldercf392 = $valueHoldercf392;

        $this->valueHoldercf392 = clone $this->valueHoldercf392;
    }

    public function __sleep()
    {
        $this->initializer0994f && ($this->initializer0994f->__invoke($valueHoldercf392, $this, '__sleep', array(), $this->initializer0994f) || 1) && $this->valueHoldercf392 = $valueHoldercf392;

        return array('valueHoldercf392');
    }
    ...
    {
        $this->initializer0994f = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer0994f;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer0994f && ($this->initializer0994f->__invoke($valueHoldercf392, $this, 'initializeProxy', array(), $this->initializer0994f) || 1) && $this->valueHoldercf392 = $valueHoldercf392;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHoldercf392;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHoldercf392;
    }
}
