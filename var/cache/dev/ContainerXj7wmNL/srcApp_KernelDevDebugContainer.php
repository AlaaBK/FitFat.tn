...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolderd577a = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer99cbf = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicPropertiesc0d28 = [
        
    ];

    public function getConnection()
    {
        $this->initializer99cbf && ($this->initializer99cbf->__invoke($valueHolderd577a, $this, 'getConnection', array(), $this->initializer99cbf) || 1) && $this->valueHolderd577a = $valueHolderd577a;

        return $this->valueHolderd577a->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer99cbf && ($this->initializer99cbf->__invoke($valueHolderd577a, $this, 'getMetadataFactory', array(), $this->initializer99cbf) || 1) && $this->valueHolderd577a = $valueHolderd577a;

        return $this->valueHolderd577a->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer99cbf && ($this->initializer99cbf->__invoke($valueHolderd577a, $this, 'getExpressionBuilder', array(), $this->initializer99cbf) || 1) && $this->valueHolderd577a = $valueHolderd577a;

        return $this->valueHolderd577a->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer99cbf && ($this->initializer99cbf->__invoke($valueHolderd577a, $this, 'beginTransaction', array(), $this->initializer99cbf) || 1) && $this->valueHolderd577a = $valueHolderd577a;

        return $this->valueHolderd577a->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer99cbf && ($this->initializer99cbf->__invoke($valueHolderd577a, $this, 'getCache', array(), $this->initializer99cbf) || 1) && $this->valueHolderd577a = $valueHolderd577a;

        return $this->valueHolderd577a->getCache();
    }

    public function transactional($func)
    {
        $this->initializer99cbf && ($this->initializer99cbf->__invoke($valueHolderd577a, $this, 'transactional', array('func' => $func), $this->initializer99cbf) || 1) && $this->valueHolderd577a = $valueHolderd577a;

        return $this->valueHolderd577a->transactional($func);
    }

    public function commit()
    {
        $this->initializer99cbf && ($this->initializer99cbf->__invoke($valueHolderd577a, $this, 'commit', array(), $this->initializer99cbf) || 1) && $this->valueHolderd577a = $valueHolderd577a;

        return $this->valueHolderd577a->commit();
    }

    public function rollback()
    {
        $this->initializer99cbf && ($this->initializer99cbf->__invoke($valueHolderd577a, $this, 'rollback', array(), $this->initializer99cbf) || 1) && $this->valueHolderd577a = $valueHolderd577a;

        return $this->valueHolderd577a->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer99cbf && ($this->initializer99cbf->__invoke($valueHolderd577a, $this, 'getClassMetadata', array('className' => $className), $this->initializer99cbf) || 1) && $this->valueHolderd577a = $valueHolderd577a;

        return $this->valueHolderd577a->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer99cbf && ($this->initializer99cbf->__invoke($valueHolderd577a, $this, 'createQuery', array('dql' => $dql), $this->initializer99cbf) || 1) && $this->valueHolderd577a = $valueHolderd577a;

        return $this->valueHolderd577a->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer99cbf && ($this->initializer99cbf->__invoke($valueHolderd577a, $this, 'createNamedQuery', array('name' => $name), $this->initializer99cbf) || 1) && $this->valueHolderd577a = $valueHolderd577a;

        return $this->valueHolderd577a->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer99cbf && ($this->initializer99cbf->__invoke($valueHolderd577a, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer99cbf) || 1) && $this->valueHolderd577a = $valueHolderd577a;

        return $this->valueHolderd577a->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer99cbf && ($this->initializer99cbf->__invoke($valueHolderd577a, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer99cbf) || 1) && $this->valueHolderd577a = $valueHolderd577a;

        return $this->valueHolderd577a->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer99cbf && ($this->initializer99cbf->__invoke($valueHolderd577a, $this, 'createQueryBuilder', array(), $this->initializer99cbf) || 1) && $this->valueHolderd577a = $valueHolderd577a;

        return $this->valueHolderd577a->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer99cbf && ($this->initializer99cbf->__invoke($valueHolderd577a, $this, 'flush', array('entity' => $entity), $this->initializer99cbf) || 1) && $this->valueHolderd577a = $valueHolderd577a;

        return $this->valueHolderd577a->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer99cbf && ($this->initializer99cbf->__invoke($valueHolderd577a, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer99cbf) || 1) && $this->valueHolderd577a = $valueHolderd577a;

        return $this->valueHolderd577a->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer99cbf && ($this->initializer99cbf->__invoke($valueHolderd577a, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer99cbf) || 1) && $this->valueHolderd577a = $valueHolderd577a;

        return $this->valueHolderd577a->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer99cbf && ($this->initializer99cbf->__invoke($valueHolderd577a, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer99cbf) || 1) && $this->valueHolderd577a = $valueHolderd577a;

        return $this->valueHolderd577a->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer99cbf && ($this->initializer99cbf->__invoke($valueHolderd577a, $this, 'clear', array('entityName' => $entityName), $this->initializer99cbf) || 1) && $this->valueHolderd577a = $valueHolderd577a;

        return $this->valueHolderd577a->clear($entityName);
    }

    public function close()
    {
        $this->initializer99cbf && ($this->initializer99cbf->__invoke($valueHolderd577a, $this, 'close', array(), $this->initializer99cbf) || 1) && $this->valueHolderd577a = $valueHolderd577a;

        return $this->valueHolderd577a->close();
    }

    public function persist($entity)
    {
        $this->initializer99cbf && ($this->initializer99cbf->__invoke($valueHolderd577a, $this, 'persist', array('entity' => $entity), $this->initializer99cbf) || 1) && $this->valueHolderd577a = $valueHolderd577a;

        return $this->valueHolderd577a->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer99cbf && ($this->initializer99cbf->__invoke($valueHolderd577a, $this, 'remove', array('entity' => $entity), $this->initializer99cbf) || 1) && $this->valueHolderd577a = $valueHolderd577a;

        return $this->valueHolderd577a->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer99cbf && ($this->initializer99cbf->__invoke($valueHolderd577a, $this, 'refresh', array('entity' => $entity), $this->initializer99cbf) || 1) && $this->valueHolderd577a = $valueHolderd577a;

        return $this->valueHolderd577a->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer99cbf && ($this->initializer99cbf->__invoke($valueHolderd577a, $this, 'detach', array('entity' => $entity), $this->initializer99cbf) || 1) && $this->valueHolderd577a = $valueHolderd577a;

        return $this->valueHolderd577a->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer99cbf && ($this->initializer99cbf->__invoke($valueHolderd577a, $this, 'merge', array('entity' => $entity), $this->initializer99cbf) || 1) && $this->valueHolderd577a = $valueHolderd577a;

        return $this->valueHolderd577a->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer99cbf && ($this->initializer99cbf->__invoke($valueHolderd577a, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer99cbf) || 1) && $this->valueHolderd577a = $valueHolderd577a;

        return $this->valueHolderd577a->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer99cbf && ($this->initializer99cbf->__invoke($valueHolderd577a, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer99cbf) || 1) && $this->valueHolderd577a = $valueHolderd577a;

        return $this->valueHolderd577a->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer99cbf && ($this->initializer99cbf->__invoke($valueHolderd577a, $this, 'getRepository', array('entityName' => $entityName), $this->initializer99cbf) || 1) && $this->valueHolderd577a = $valueHolderd577a;

        return $this->valueHolderd577a->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer99cbf && ($this->initializer99cbf->__invoke($valueHolderd577a, $this, 'contains', array('entity' => $entity), $this->initializer99cbf) || 1) && $this->valueHolderd577a = $valueHolderd577a;

        return $this->valueHolderd577a->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer99cbf && ($this->initializer99cbf->__invoke($valueHolderd577a, $this, 'getEventManager', array(), $this->initializer99cbf) || 1) && $this->valueHolderd577a = $valueHolderd577a;

        return $this->valueHolderd577a->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer99cbf && ($this->initializer99cbf->__invoke($valueHolderd577a, $this, 'getConfiguration', array(), $this->initializer99cbf) || 1) && $this->valueHolderd577a = $valueHolderd577a;

        return $this->valueHolderd577a->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer99cbf && ($this->initializer99cbf->__invoke($valueHolderd577a, $this, 'isOpen', array(), $this->initializer99cbf) || 1) && $this->valueHolderd577a = $valueHolderd577a;

        return $this->valueHolderd577a->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer99cbf && ($this->initializer99cbf->__invoke($valueHolderd577a, $this, 'getUnitOfWork', array(), $this->initializer99cbf) || 1) && $this->valueHolderd577a = $valueHolderd577a;

        return $this->valueHolderd577a->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer99cbf && ($this->initializer99cbf->__invoke($valueHolderd577a, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer99cbf) || 1) && $this->valueHolderd577a = $valueHolderd577a;

        return $this->valueHolderd577a->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer99cbf && ($this->initializer99cbf->__invoke($valueHolderd577a, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer99cbf) || 1) && $this->valueHolderd577a = $valueHolderd577a;

        return $this->valueHolderd577a->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer99cbf && ($this->initializer99cbf->__invoke($valueHolderd577a, $this, 'getProxyFactory', array(), $this->initializer99cbf) || 1) && $this->valueHolderd577a = $valueHolderd577a;

        return $this->valueHolderd577a->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer99cbf && ($this->initializer99cbf->__invoke($valueHolderd577a, $this, 'initializeObject', array('obj' => $obj), $this->initializer99cbf) || 1) && $this->valueHolderd577a = $valueHolderd577a;

        return $this->valueHolderd577a->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer99cbf && ($this->initializer99cbf->__invoke($valueHolderd577a, $this, 'getFilters', array(), $this->initializer99cbf) || 1) && $this->valueHolderd577a = $valueHolderd577a;

        return $this->valueHolderd577a->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer99cbf && ($this->initializer99cbf->__invoke($valueHolderd577a, $this, 'isFiltersStateClean', array(), $this->initializer99cbf) || 1) && $this->valueHolderd577a = $valueHolderd577a;

        return $this->valueHolderd577a->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer99cbf && ($this->initializer99cbf->__invoke($valueHolderd577a, $this, 'hasFilters', array(), $this->initializer99cbf) || 1) && $this->valueHolderd577a = $valueHolderd577a;

        return $this->valueHolderd577a->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer99cbf = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolderd577a) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolderd577a = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolderd577a->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer99cbf && ($this->initializer99cbf->__invoke($valueHolderd577a, $this, '__get', ['name' => $name], $this->initializer99cbf) || 1) && $this->valueHolderd577a = $valueHolderd577a;

        if (isset(self::$publicPropertiesc0d28[$name])) {
            return $this->valueHolderd577a->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolderd577a;
    ...
    {
        $this->initializer99cbf && ($this->initializer99cbf->__invoke($valueHolderd577a, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer99cbf) || 1) && $this->valueHolderd577a = $valueHolderd577a;
    ...
    {
        $this->initializer99cbf && ($this->initializer99cbf->__invoke($valueHolderd577a, $this, '__isset', array('name' => $name), $this->initializer99cbf) || 1) && $this->valueHolderd577a = $valueHolderd577a;
    ...
    {
        $this->initializer99cbf && ($this->initializer99cbf->__invoke($valueHolderd577a, $this, '__unset', array('name' => $name), $this->initializer99cbf) || 1) && $this->valueHolderd577a = $valueHolderd577a;
    ...
    {
        $this->initializer99cbf && ($this->initializer99cbf->__invoke($valueHolderd577a, $this, '__clone', array(), $this->initializer99cbf) || 1) && $this->valueHolderd577a = $valueHolderd577a;

        $this->valueHolderd577a = clone $this->valueHolderd577a;
    }

    public function __sleep()
    {
        $this->initializer99cbf && ($this->initializer99cbf->__invoke($valueHolderd577a, $this, '__sleep', array(), $this->initializer99cbf) || 1) && $this->valueHolderd577a = $valueHolderd577a;

        return array('valueHolderd577a');
    }
    ...
    {
        $this->initializer99cbf = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer99cbf;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer99cbf && ($this->initializer99cbf->__invoke($valueHolderd577a, $this, 'initializeProxy', array(), $this->initializer99cbf) || 1) && $this->valueHolderd577a = $valueHolderd577a;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolderd577a;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolderd577a;
    }
}
