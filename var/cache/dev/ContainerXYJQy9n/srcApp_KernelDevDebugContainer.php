...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder0459d = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializercd63e = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties65400 = [
        
    ];

    public function getConnection()
    {
        $this->initializercd63e && ($this->initializercd63e->__invoke($valueHolder0459d, $this, 'getConnection', array(), $this->initializercd63e) || 1) && $this->valueHolder0459d = $valueHolder0459d;

        return $this->valueHolder0459d->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializercd63e && ($this->initializercd63e->__invoke($valueHolder0459d, $this, 'getMetadataFactory', array(), $this->initializercd63e) || 1) && $this->valueHolder0459d = $valueHolder0459d;

        return $this->valueHolder0459d->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializercd63e && ($this->initializercd63e->__invoke($valueHolder0459d, $this, 'getExpressionBuilder', array(), $this->initializercd63e) || 1) && $this->valueHolder0459d = $valueHolder0459d;

        return $this->valueHolder0459d->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializercd63e && ($this->initializercd63e->__invoke($valueHolder0459d, $this, 'beginTransaction', array(), $this->initializercd63e) || 1) && $this->valueHolder0459d = $valueHolder0459d;

        return $this->valueHolder0459d->beginTransaction();
    }

    public function getCache()
    {
        $this->initializercd63e && ($this->initializercd63e->__invoke($valueHolder0459d, $this, 'getCache', array(), $this->initializercd63e) || 1) && $this->valueHolder0459d = $valueHolder0459d;

        return $this->valueHolder0459d->getCache();
    }

    public function transactional($func)
    {
        $this->initializercd63e && ($this->initializercd63e->__invoke($valueHolder0459d, $this, 'transactional', array('func' => $func), $this->initializercd63e) || 1) && $this->valueHolder0459d = $valueHolder0459d;

        return $this->valueHolder0459d->transactional($func);
    }

    public function commit()
    {
        $this->initializercd63e && ($this->initializercd63e->__invoke($valueHolder0459d, $this, 'commit', array(), $this->initializercd63e) || 1) && $this->valueHolder0459d = $valueHolder0459d;

        return $this->valueHolder0459d->commit();
    }

    public function rollback()
    {
        $this->initializercd63e && ($this->initializercd63e->__invoke($valueHolder0459d, $this, 'rollback', array(), $this->initializercd63e) || 1) && $this->valueHolder0459d = $valueHolder0459d;

        return $this->valueHolder0459d->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializercd63e && ($this->initializercd63e->__invoke($valueHolder0459d, $this, 'getClassMetadata', array('className' => $className), $this->initializercd63e) || 1) && $this->valueHolder0459d = $valueHolder0459d;

        return $this->valueHolder0459d->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializercd63e && ($this->initializercd63e->__invoke($valueHolder0459d, $this, 'createQuery', array('dql' => $dql), $this->initializercd63e) || 1) && $this->valueHolder0459d = $valueHolder0459d;

        return $this->valueHolder0459d->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializercd63e && ($this->initializercd63e->__invoke($valueHolder0459d, $this, 'createNamedQuery', array('name' => $name), $this->initializercd63e) || 1) && $this->valueHolder0459d = $valueHolder0459d;

        return $this->valueHolder0459d->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializercd63e && ($this->initializercd63e->__invoke($valueHolder0459d, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializercd63e) || 1) && $this->valueHolder0459d = $valueHolder0459d;

        return $this->valueHolder0459d->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializercd63e && ($this->initializercd63e->__invoke($valueHolder0459d, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializercd63e) || 1) && $this->valueHolder0459d = $valueHolder0459d;

        return $this->valueHolder0459d->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializercd63e && ($this->initializercd63e->__invoke($valueHolder0459d, $this, 'createQueryBuilder', array(), $this->initializercd63e) || 1) && $this->valueHolder0459d = $valueHolder0459d;

        return $this->valueHolder0459d->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializercd63e && ($this->initializercd63e->__invoke($valueHolder0459d, $this, 'flush', array('entity' => $entity), $this->initializercd63e) || 1) && $this->valueHolder0459d = $valueHolder0459d;

        return $this->valueHolder0459d->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializercd63e && ($this->initializercd63e->__invoke($valueHolder0459d, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializercd63e) || 1) && $this->valueHolder0459d = $valueHolder0459d;

        return $this->valueHolder0459d->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializercd63e && ($this->initializercd63e->__invoke($valueHolder0459d, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializercd63e) || 1) && $this->valueHolder0459d = $valueHolder0459d;

        return $this->valueHolder0459d->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializercd63e && ($this->initializercd63e->__invoke($valueHolder0459d, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializercd63e) || 1) && $this->valueHolder0459d = $valueHolder0459d;

        return $this->valueHolder0459d->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializercd63e && ($this->initializercd63e->__invoke($valueHolder0459d, $this, 'clear', array('entityName' => $entityName), $this->initializercd63e) || 1) && $this->valueHolder0459d = $valueHolder0459d;

        return $this->valueHolder0459d->clear($entityName);
    }

    public function close()
    {
        $this->initializercd63e && ($this->initializercd63e->__invoke($valueHolder0459d, $this, 'close', array(), $this->initializercd63e) || 1) && $this->valueHolder0459d = $valueHolder0459d;

        return $this->valueHolder0459d->close();
    }

    public function persist($entity)
    {
        $this->initializercd63e && ($this->initializercd63e->__invoke($valueHolder0459d, $this, 'persist', array('entity' => $entity), $this->initializercd63e) || 1) && $this->valueHolder0459d = $valueHolder0459d;

        return $this->valueHolder0459d->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializercd63e && ($this->initializercd63e->__invoke($valueHolder0459d, $this, 'remove', array('entity' => $entity), $this->initializercd63e) || 1) && $this->valueHolder0459d = $valueHolder0459d;

        return $this->valueHolder0459d->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializercd63e && ($this->initializercd63e->__invoke($valueHolder0459d, $this, 'refresh', array('entity' => $entity), $this->initializercd63e) || 1) && $this->valueHolder0459d = $valueHolder0459d;

        return $this->valueHolder0459d->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializercd63e && ($this->initializercd63e->__invoke($valueHolder0459d, $this, 'detach', array('entity' => $entity), $this->initializercd63e) || 1) && $this->valueHolder0459d = $valueHolder0459d;

        return $this->valueHolder0459d->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializercd63e && ($this->initializercd63e->__invoke($valueHolder0459d, $this, 'merge', array('entity' => $entity), $this->initializercd63e) || 1) && $this->valueHolder0459d = $valueHolder0459d;

        return $this->valueHolder0459d->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializercd63e && ($this->initializercd63e->__invoke($valueHolder0459d, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializercd63e) || 1) && $this->valueHolder0459d = $valueHolder0459d;

        return $this->valueHolder0459d->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializercd63e && ($this->initializercd63e->__invoke($valueHolder0459d, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializercd63e) || 1) && $this->valueHolder0459d = $valueHolder0459d;

        return $this->valueHolder0459d->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializercd63e && ($this->initializercd63e->__invoke($valueHolder0459d, $this, 'getRepository', array('entityName' => $entityName), $this->initializercd63e) || 1) && $this->valueHolder0459d = $valueHolder0459d;

        return $this->valueHolder0459d->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializercd63e && ($this->initializercd63e->__invoke($valueHolder0459d, $this, 'contains', array('entity' => $entity), $this->initializercd63e) || 1) && $this->valueHolder0459d = $valueHolder0459d;

        return $this->valueHolder0459d->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializercd63e && ($this->initializercd63e->__invoke($valueHolder0459d, $this, 'getEventManager', array(), $this->initializercd63e) || 1) && $this->valueHolder0459d = $valueHolder0459d;

        return $this->valueHolder0459d->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializercd63e && ($this->initializercd63e->__invoke($valueHolder0459d, $this, 'getConfiguration', array(), $this->initializercd63e) || 1) && $this->valueHolder0459d = $valueHolder0459d;

        return $this->valueHolder0459d->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializercd63e && ($this->initializercd63e->__invoke($valueHolder0459d, $this, 'isOpen', array(), $this->initializercd63e) || 1) && $this->valueHolder0459d = $valueHolder0459d;

        return $this->valueHolder0459d->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializercd63e && ($this->initializercd63e->__invoke($valueHolder0459d, $this, 'getUnitOfWork', array(), $this->initializercd63e) || 1) && $this->valueHolder0459d = $valueHolder0459d;

        return $this->valueHolder0459d->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializercd63e && ($this->initializercd63e->__invoke($valueHolder0459d, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializercd63e) || 1) && $this->valueHolder0459d = $valueHolder0459d;

        return $this->valueHolder0459d->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializercd63e && ($this->initializercd63e->__invoke($valueHolder0459d, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializercd63e) || 1) && $this->valueHolder0459d = $valueHolder0459d;

        return $this->valueHolder0459d->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializercd63e && ($this->initializercd63e->__invoke($valueHolder0459d, $this, 'getProxyFactory', array(), $this->initializercd63e) || 1) && $this->valueHolder0459d = $valueHolder0459d;

        return $this->valueHolder0459d->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializercd63e && ($this->initializercd63e->__invoke($valueHolder0459d, $this, 'initializeObject', array('obj' => $obj), $this->initializercd63e) || 1) && $this->valueHolder0459d = $valueHolder0459d;

        return $this->valueHolder0459d->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializercd63e && ($this->initializercd63e->__invoke($valueHolder0459d, $this, 'getFilters', array(), $this->initializercd63e) || 1) && $this->valueHolder0459d = $valueHolder0459d;

        return $this->valueHolder0459d->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializercd63e && ($this->initializercd63e->__invoke($valueHolder0459d, $this, 'isFiltersStateClean', array(), $this->initializercd63e) || 1) && $this->valueHolder0459d = $valueHolder0459d;

        return $this->valueHolder0459d->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializercd63e && ($this->initializercd63e->__invoke($valueHolder0459d, $this, 'hasFilters', array(), $this->initializercd63e) || 1) && $this->valueHolder0459d = $valueHolder0459d;

        return $this->valueHolder0459d->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializercd63e = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder0459d) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder0459d = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder0459d->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializercd63e && ($this->initializercd63e->__invoke($valueHolder0459d, $this, '__get', ['name' => $name], $this->initializercd63e) || 1) && $this->valueHolder0459d = $valueHolder0459d;

        if (isset(self::$publicProperties65400[$name])) {
            return $this->valueHolder0459d->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder0459d;
    ...
    {
        $this->initializercd63e && ($this->initializercd63e->__invoke($valueHolder0459d, $this, '__set', array('name' => $name, 'value' => $value), $this->initializercd63e) || 1) && $this->valueHolder0459d = $valueHolder0459d;
    ...
    {
        $this->initializercd63e && ($this->initializercd63e->__invoke($valueHolder0459d, $this, '__isset', array('name' => $name), $this->initializercd63e) || 1) && $this->valueHolder0459d = $valueHolder0459d;
    ...
    {
        $this->initializercd63e && ($this->initializercd63e->__invoke($valueHolder0459d, $this, '__unset', array('name' => $name), $this->initializercd63e) || 1) && $this->valueHolder0459d = $valueHolder0459d;
    ...
    {
        $this->initializercd63e && ($this->initializercd63e->__invoke($valueHolder0459d, $this, '__clone', array(), $this->initializercd63e) || 1) && $this->valueHolder0459d = $valueHolder0459d;

        $this->valueHolder0459d = clone $this->valueHolder0459d;
    }

    public function __sleep()
    {
        $this->initializercd63e && ($this->initializercd63e->__invoke($valueHolder0459d, $this, '__sleep', array(), $this->initializercd63e) || 1) && $this->valueHolder0459d = $valueHolder0459d;

        return array('valueHolder0459d');
    }
    ...
    {
        $this->initializercd63e = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializercd63e;
    }

    public function initializeProxy() : bool
    {
        return $this->initializercd63e && ($this->initializercd63e->__invoke($valueHolder0459d, $this, 'initializeProxy', array(), $this->initializercd63e) || 1) && $this->valueHolder0459d = $valueHolder0459d;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder0459d;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder0459d;
    }
}
