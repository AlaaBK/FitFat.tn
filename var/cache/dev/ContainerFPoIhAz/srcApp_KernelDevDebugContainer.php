...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder3d8db = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer08f9c = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties4af76 = [
        
    ];

    public function getConnection()
    {
        $this->initializer08f9c && ($this->initializer08f9c->__invoke($valueHolder3d8db, $this, 'getConnection', array(), $this->initializer08f9c) || 1) && $this->valueHolder3d8db = $valueHolder3d8db;

        return $this->valueHolder3d8db->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer08f9c && ($this->initializer08f9c->__invoke($valueHolder3d8db, $this, 'getMetadataFactory', array(), $this->initializer08f9c) || 1) && $this->valueHolder3d8db = $valueHolder3d8db;

        return $this->valueHolder3d8db->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer08f9c && ($this->initializer08f9c->__invoke($valueHolder3d8db, $this, 'getExpressionBuilder', array(), $this->initializer08f9c) || 1) && $this->valueHolder3d8db = $valueHolder3d8db;

        return $this->valueHolder3d8db->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer08f9c && ($this->initializer08f9c->__invoke($valueHolder3d8db, $this, 'beginTransaction', array(), $this->initializer08f9c) || 1) && $this->valueHolder3d8db = $valueHolder3d8db;

        return $this->valueHolder3d8db->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer08f9c && ($this->initializer08f9c->__invoke($valueHolder3d8db, $this, 'getCache', array(), $this->initializer08f9c) || 1) && $this->valueHolder3d8db = $valueHolder3d8db;

        return $this->valueHolder3d8db->getCache();
    }

    public function transactional($func)
    {
        $this->initializer08f9c && ($this->initializer08f9c->__invoke($valueHolder3d8db, $this, 'transactional', array('func' => $func), $this->initializer08f9c) || 1) && $this->valueHolder3d8db = $valueHolder3d8db;

        return $this->valueHolder3d8db->transactional($func);
    }

    public function commit()
    {
        $this->initializer08f9c && ($this->initializer08f9c->__invoke($valueHolder3d8db, $this, 'commit', array(), $this->initializer08f9c) || 1) && $this->valueHolder3d8db = $valueHolder3d8db;

        return $this->valueHolder3d8db->commit();
    }

    public function rollback()
    {
        $this->initializer08f9c && ($this->initializer08f9c->__invoke($valueHolder3d8db, $this, 'rollback', array(), $this->initializer08f9c) || 1) && $this->valueHolder3d8db = $valueHolder3d8db;

        return $this->valueHolder3d8db->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer08f9c && ($this->initializer08f9c->__invoke($valueHolder3d8db, $this, 'getClassMetadata', array('className' => $className), $this->initializer08f9c) || 1) && $this->valueHolder3d8db = $valueHolder3d8db;

        return $this->valueHolder3d8db->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer08f9c && ($this->initializer08f9c->__invoke($valueHolder3d8db, $this, 'createQuery', array('dql' => $dql), $this->initializer08f9c) || 1) && $this->valueHolder3d8db = $valueHolder3d8db;

        return $this->valueHolder3d8db->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer08f9c && ($this->initializer08f9c->__invoke($valueHolder3d8db, $this, 'createNamedQuery', array('name' => $name), $this->initializer08f9c) || 1) && $this->valueHolder3d8db = $valueHolder3d8db;

        return $this->valueHolder3d8db->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer08f9c && ($this->initializer08f9c->__invoke($valueHolder3d8db, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer08f9c) || 1) && $this->valueHolder3d8db = $valueHolder3d8db;

        return $this->valueHolder3d8db->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer08f9c && ($this->initializer08f9c->__invoke($valueHolder3d8db, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer08f9c) || 1) && $this->valueHolder3d8db = $valueHolder3d8db;

        return $this->valueHolder3d8db->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer08f9c && ($this->initializer08f9c->__invoke($valueHolder3d8db, $this, 'createQueryBuilder', array(), $this->initializer08f9c) || 1) && $this->valueHolder3d8db = $valueHolder3d8db;

        return $this->valueHolder3d8db->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer08f9c && ($this->initializer08f9c->__invoke($valueHolder3d8db, $this, 'flush', array('entity' => $entity), $this->initializer08f9c) || 1) && $this->valueHolder3d8db = $valueHolder3d8db;

        return $this->valueHolder3d8db->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer08f9c && ($this->initializer08f9c->__invoke($valueHolder3d8db, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer08f9c) || 1) && $this->valueHolder3d8db = $valueHolder3d8db;

        return $this->valueHolder3d8db->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer08f9c && ($this->initializer08f9c->__invoke($valueHolder3d8db, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer08f9c) || 1) && $this->valueHolder3d8db = $valueHolder3d8db;

        return $this->valueHolder3d8db->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer08f9c && ($this->initializer08f9c->__invoke($valueHolder3d8db, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer08f9c) || 1) && $this->valueHolder3d8db = $valueHolder3d8db;

        return $this->valueHolder3d8db->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer08f9c && ($this->initializer08f9c->__invoke($valueHolder3d8db, $this, 'clear', array('entityName' => $entityName), $this->initializer08f9c) || 1) && $this->valueHolder3d8db = $valueHolder3d8db;

        return $this->valueHolder3d8db->clear($entityName);
    }

    public function close()
    {
        $this->initializer08f9c && ($this->initializer08f9c->__invoke($valueHolder3d8db, $this, 'close', array(), $this->initializer08f9c) || 1) && $this->valueHolder3d8db = $valueHolder3d8db;

        return $this->valueHolder3d8db->close();
    }

    public function persist($entity)
    {
        $this->initializer08f9c && ($this->initializer08f9c->__invoke($valueHolder3d8db, $this, 'persist', array('entity' => $entity), $this->initializer08f9c) || 1) && $this->valueHolder3d8db = $valueHolder3d8db;

        return $this->valueHolder3d8db->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer08f9c && ($this->initializer08f9c->__invoke($valueHolder3d8db, $this, 'remove', array('entity' => $entity), $this->initializer08f9c) || 1) && $this->valueHolder3d8db = $valueHolder3d8db;

        return $this->valueHolder3d8db->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer08f9c && ($this->initializer08f9c->__invoke($valueHolder3d8db, $this, 'refresh', array('entity' => $entity), $this->initializer08f9c) || 1) && $this->valueHolder3d8db = $valueHolder3d8db;

        return $this->valueHolder3d8db->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer08f9c && ($this->initializer08f9c->__invoke($valueHolder3d8db, $this, 'detach', array('entity' => $entity), $this->initializer08f9c) || 1) && $this->valueHolder3d8db = $valueHolder3d8db;

        return $this->valueHolder3d8db->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer08f9c && ($this->initializer08f9c->__invoke($valueHolder3d8db, $this, 'merge', array('entity' => $entity), $this->initializer08f9c) || 1) && $this->valueHolder3d8db = $valueHolder3d8db;

        return $this->valueHolder3d8db->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer08f9c && ($this->initializer08f9c->__invoke($valueHolder3d8db, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer08f9c) || 1) && $this->valueHolder3d8db = $valueHolder3d8db;

        return $this->valueHolder3d8db->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer08f9c && ($this->initializer08f9c->__invoke($valueHolder3d8db, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer08f9c) || 1) && $this->valueHolder3d8db = $valueHolder3d8db;

        return $this->valueHolder3d8db->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer08f9c && ($this->initializer08f9c->__invoke($valueHolder3d8db, $this, 'getRepository', array('entityName' => $entityName), $this->initializer08f9c) || 1) && $this->valueHolder3d8db = $valueHolder3d8db;

        return $this->valueHolder3d8db->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer08f9c && ($this->initializer08f9c->__invoke($valueHolder3d8db, $this, 'contains', array('entity' => $entity), $this->initializer08f9c) || 1) && $this->valueHolder3d8db = $valueHolder3d8db;

        return $this->valueHolder3d8db->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer08f9c && ($this->initializer08f9c->__invoke($valueHolder3d8db, $this, 'getEventManager', array(), $this->initializer08f9c) || 1) && $this->valueHolder3d8db = $valueHolder3d8db;

        return $this->valueHolder3d8db->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer08f9c && ($this->initializer08f9c->__invoke($valueHolder3d8db, $this, 'getConfiguration', array(), $this->initializer08f9c) || 1) && $this->valueHolder3d8db = $valueHolder3d8db;

        return $this->valueHolder3d8db->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer08f9c && ($this->initializer08f9c->__invoke($valueHolder3d8db, $this, 'isOpen', array(), $this->initializer08f9c) || 1) && $this->valueHolder3d8db = $valueHolder3d8db;

        return $this->valueHolder3d8db->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer08f9c && ($this->initializer08f9c->__invoke($valueHolder3d8db, $this, 'getUnitOfWork', array(), $this->initializer08f9c) || 1) && $this->valueHolder3d8db = $valueHolder3d8db;

        return $this->valueHolder3d8db->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer08f9c && ($this->initializer08f9c->__invoke($valueHolder3d8db, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer08f9c) || 1) && $this->valueHolder3d8db = $valueHolder3d8db;

        return $this->valueHolder3d8db->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer08f9c && ($this->initializer08f9c->__invoke($valueHolder3d8db, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer08f9c) || 1) && $this->valueHolder3d8db = $valueHolder3d8db;

        return $this->valueHolder3d8db->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer08f9c && ($this->initializer08f9c->__invoke($valueHolder3d8db, $this, 'getProxyFactory', array(), $this->initializer08f9c) || 1) && $this->valueHolder3d8db = $valueHolder3d8db;

        return $this->valueHolder3d8db->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer08f9c && ($this->initializer08f9c->__invoke($valueHolder3d8db, $this, 'initializeObject', array('obj' => $obj), $this->initializer08f9c) || 1) && $this->valueHolder3d8db = $valueHolder3d8db;

        return $this->valueHolder3d8db->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer08f9c && ($this->initializer08f9c->__invoke($valueHolder3d8db, $this, 'getFilters', array(), $this->initializer08f9c) || 1) && $this->valueHolder3d8db = $valueHolder3d8db;

        return $this->valueHolder3d8db->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer08f9c && ($this->initializer08f9c->__invoke($valueHolder3d8db, $this, 'isFiltersStateClean', array(), $this->initializer08f9c) || 1) && $this->valueHolder3d8db = $valueHolder3d8db;

        return $this->valueHolder3d8db->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer08f9c && ($this->initializer08f9c->__invoke($valueHolder3d8db, $this, 'hasFilters', array(), $this->initializer08f9c) || 1) && $this->valueHolder3d8db = $valueHolder3d8db;

        return $this->valueHolder3d8db->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer08f9c = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder3d8db) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder3d8db = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder3d8db->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer08f9c && ($this->initializer08f9c->__invoke($valueHolder3d8db, $this, '__get', ['name' => $name], $this->initializer08f9c) || 1) && $this->valueHolder3d8db = $valueHolder3d8db;

        if (isset(self::$publicProperties4af76[$name])) {
            return $this->valueHolder3d8db->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder3d8db;
    ...
    {
        $this->initializer08f9c && ($this->initializer08f9c->__invoke($valueHolder3d8db, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer08f9c) || 1) && $this->valueHolder3d8db = $valueHolder3d8db;
    ...
    {
        $this->initializer08f9c && ($this->initializer08f9c->__invoke($valueHolder3d8db, $this, '__isset', array('name' => $name), $this->initializer08f9c) || 1) && $this->valueHolder3d8db = $valueHolder3d8db;
    ...
    {
        $this->initializer08f9c && ($this->initializer08f9c->__invoke($valueHolder3d8db, $this, '__unset', array('name' => $name), $this->initializer08f9c) || 1) && $this->valueHolder3d8db = $valueHolder3d8db;
    ...
    {
        $this->initializer08f9c && ($this->initializer08f9c->__invoke($valueHolder3d8db, $this, '__clone', array(), $this->initializer08f9c) || 1) && $this->valueHolder3d8db = $valueHolder3d8db;

        $this->valueHolder3d8db = clone $this->valueHolder3d8db;
    }

    public function __sleep()
    {
        $this->initializer08f9c && ($this->initializer08f9c->__invoke($valueHolder3d8db, $this, '__sleep', array(), $this->initializer08f9c) || 1) && $this->valueHolder3d8db = $valueHolder3d8db;

        return array('valueHolder3d8db');
    }
    ...
    {
        $this->initializer08f9c = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer08f9c;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer08f9c && ($this->initializer08f9c->__invoke($valueHolder3d8db, $this, 'initializeProxy', array(), $this->initializer08f9c) || 1) && $this->valueHolder3d8db = $valueHolder3d8db;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder3d8db;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder3d8db;
    }
}
