...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder85c6a = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializerec77b = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties4cffe = [
        
    ];

    public function getConnection()
    {
        $this->initializerec77b && ($this->initializerec77b->__invoke($valueHolder85c6a, $this, 'getConnection', array(), $this->initializerec77b) || 1) && $this->valueHolder85c6a = $valueHolder85c6a;

        return $this->valueHolder85c6a->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializerec77b && ($this->initializerec77b->__invoke($valueHolder85c6a, $this, 'getMetadataFactory', array(), $this->initializerec77b) || 1) && $this->valueHolder85c6a = $valueHolder85c6a;

        return $this->valueHolder85c6a->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializerec77b && ($this->initializerec77b->__invoke($valueHolder85c6a, $this, 'getExpressionBuilder', array(), $this->initializerec77b) || 1) && $this->valueHolder85c6a = $valueHolder85c6a;

        return $this->valueHolder85c6a->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializerec77b && ($this->initializerec77b->__invoke($valueHolder85c6a, $this, 'beginTransaction', array(), $this->initializerec77b) || 1) && $this->valueHolder85c6a = $valueHolder85c6a;

        return $this->valueHolder85c6a->beginTransaction();
    }

    public function getCache()
    {
        $this->initializerec77b && ($this->initializerec77b->__invoke($valueHolder85c6a, $this, 'getCache', array(), $this->initializerec77b) || 1) && $this->valueHolder85c6a = $valueHolder85c6a;

        return $this->valueHolder85c6a->getCache();
    }

    public function transactional($func)
    {
        $this->initializerec77b && ($this->initializerec77b->__invoke($valueHolder85c6a, $this, 'transactional', array('func' => $func), $this->initializerec77b) || 1) && $this->valueHolder85c6a = $valueHolder85c6a;

        return $this->valueHolder85c6a->transactional($func);
    }

    public function commit()
    {
        $this->initializerec77b && ($this->initializerec77b->__invoke($valueHolder85c6a, $this, 'commit', array(), $this->initializerec77b) || 1) && $this->valueHolder85c6a = $valueHolder85c6a;

        return $this->valueHolder85c6a->commit();
    }

    public function rollback()
    {
        $this->initializerec77b && ($this->initializerec77b->__invoke($valueHolder85c6a, $this, 'rollback', array(), $this->initializerec77b) || 1) && $this->valueHolder85c6a = $valueHolder85c6a;

        return $this->valueHolder85c6a->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializerec77b && ($this->initializerec77b->__invoke($valueHolder85c6a, $this, 'getClassMetadata', array('className' => $className), $this->initializerec77b) || 1) && $this->valueHolder85c6a = $valueHolder85c6a;

        return $this->valueHolder85c6a->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializerec77b && ($this->initializerec77b->__invoke($valueHolder85c6a, $this, 'createQuery', array('dql' => $dql), $this->initializerec77b) || 1) && $this->valueHolder85c6a = $valueHolder85c6a;

        return $this->valueHolder85c6a->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializerec77b && ($this->initializerec77b->__invoke($valueHolder85c6a, $this, 'createNamedQuery', array('name' => $name), $this->initializerec77b) || 1) && $this->valueHolder85c6a = $valueHolder85c6a;

        return $this->valueHolder85c6a->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializerec77b && ($this->initializerec77b->__invoke($valueHolder85c6a, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializerec77b) || 1) && $this->valueHolder85c6a = $valueHolder85c6a;

        return $this->valueHolder85c6a->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializerec77b && ($this->initializerec77b->__invoke($valueHolder85c6a, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializerec77b) || 1) && $this->valueHolder85c6a = $valueHolder85c6a;

        return $this->valueHolder85c6a->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializerec77b && ($this->initializerec77b->__invoke($valueHolder85c6a, $this, 'createQueryBuilder', array(), $this->initializerec77b) || 1) && $this->valueHolder85c6a = $valueHolder85c6a;

        return $this->valueHolder85c6a->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializerec77b && ($this->initializerec77b->__invoke($valueHolder85c6a, $this, 'flush', array('entity' => $entity), $this->initializerec77b) || 1) && $this->valueHolder85c6a = $valueHolder85c6a;

        return $this->valueHolder85c6a->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializerec77b && ($this->initializerec77b->__invoke($valueHolder85c6a, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerec77b) || 1) && $this->valueHolder85c6a = $valueHolder85c6a;

        return $this->valueHolder85c6a->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializerec77b && ($this->initializerec77b->__invoke($valueHolder85c6a, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializerec77b) || 1) && $this->valueHolder85c6a = $valueHolder85c6a;

        return $this->valueHolder85c6a->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializerec77b && ($this->initializerec77b->__invoke($valueHolder85c6a, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializerec77b) || 1) && $this->valueHolder85c6a = $valueHolder85c6a;

        return $this->valueHolder85c6a->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializerec77b && ($this->initializerec77b->__invoke($valueHolder85c6a, $this, 'clear', array('entityName' => $entityName), $this->initializerec77b) || 1) && $this->valueHolder85c6a = $valueHolder85c6a;

        return $this->valueHolder85c6a->clear($entityName);
    }

    public function close()
    {
        $this->initializerec77b && ($this->initializerec77b->__invoke($valueHolder85c6a, $this, 'close', array(), $this->initializerec77b) || 1) && $this->valueHolder85c6a = $valueHolder85c6a;

        return $this->valueHolder85c6a->close();
    }

    public function persist($entity)
    {
        $this->initializerec77b && ($this->initializerec77b->__invoke($valueHolder85c6a, $this, 'persist', array('entity' => $entity), $this->initializerec77b) || 1) && $this->valueHolder85c6a = $valueHolder85c6a;

        return $this->valueHolder85c6a->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializerec77b && ($this->initializerec77b->__invoke($valueHolder85c6a, $this, 'remove', array('entity' => $entity), $this->initializerec77b) || 1) && $this->valueHolder85c6a = $valueHolder85c6a;

        return $this->valueHolder85c6a->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializerec77b && ($this->initializerec77b->__invoke($valueHolder85c6a, $this, 'refresh', array('entity' => $entity), $this->initializerec77b) || 1) && $this->valueHolder85c6a = $valueHolder85c6a;

        return $this->valueHolder85c6a->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializerec77b && ($this->initializerec77b->__invoke($valueHolder85c6a, $this, 'detach', array('entity' => $entity), $this->initializerec77b) || 1) && $this->valueHolder85c6a = $valueHolder85c6a;

        return $this->valueHolder85c6a->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializerec77b && ($this->initializerec77b->__invoke($valueHolder85c6a, $this, 'merge', array('entity' => $entity), $this->initializerec77b) || 1) && $this->valueHolder85c6a = $valueHolder85c6a;

        return $this->valueHolder85c6a->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializerec77b && ($this->initializerec77b->__invoke($valueHolder85c6a, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializerec77b) || 1) && $this->valueHolder85c6a = $valueHolder85c6a;

        return $this->valueHolder85c6a->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializerec77b && ($this->initializerec77b->__invoke($valueHolder85c6a, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerec77b) || 1) && $this->valueHolder85c6a = $valueHolder85c6a;

        return $this->valueHolder85c6a->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializerec77b && ($this->initializerec77b->__invoke($valueHolder85c6a, $this, 'getRepository', array('entityName' => $entityName), $this->initializerec77b) || 1) && $this->valueHolder85c6a = $valueHolder85c6a;

        return $this->valueHolder85c6a->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializerec77b && ($this->initializerec77b->__invoke($valueHolder85c6a, $this, 'contains', array('entity' => $entity), $this->initializerec77b) || 1) && $this->valueHolder85c6a = $valueHolder85c6a;

        return $this->valueHolder85c6a->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializerec77b && ($this->initializerec77b->__invoke($valueHolder85c6a, $this, 'getEventManager', array(), $this->initializerec77b) || 1) && $this->valueHolder85c6a = $valueHolder85c6a;

        return $this->valueHolder85c6a->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializerec77b && ($this->initializerec77b->__invoke($valueHolder85c6a, $this, 'getConfiguration', array(), $this->initializerec77b) || 1) && $this->valueHolder85c6a = $valueHolder85c6a;

        return $this->valueHolder85c6a->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializerec77b && ($this->initializerec77b->__invoke($valueHolder85c6a, $this, 'isOpen', array(), $this->initializerec77b) || 1) && $this->valueHolder85c6a = $valueHolder85c6a;

        return $this->valueHolder85c6a->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializerec77b && ($this->initializerec77b->__invoke($valueHolder85c6a, $this, 'getUnitOfWork', array(), $this->initializerec77b) || 1) && $this->valueHolder85c6a = $valueHolder85c6a;

        return $this->valueHolder85c6a->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializerec77b && ($this->initializerec77b->__invoke($valueHolder85c6a, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializerec77b) || 1) && $this->valueHolder85c6a = $valueHolder85c6a;

        return $this->valueHolder85c6a->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializerec77b && ($this->initializerec77b->__invoke($valueHolder85c6a, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializerec77b) || 1) && $this->valueHolder85c6a = $valueHolder85c6a;

        return $this->valueHolder85c6a->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializerec77b && ($this->initializerec77b->__invoke($valueHolder85c6a, $this, 'getProxyFactory', array(), $this->initializerec77b) || 1) && $this->valueHolder85c6a = $valueHolder85c6a;

        return $this->valueHolder85c6a->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializerec77b && ($this->initializerec77b->__invoke($valueHolder85c6a, $this, 'initializeObject', array('obj' => $obj), $this->initializerec77b) || 1) && $this->valueHolder85c6a = $valueHolder85c6a;

        return $this->valueHolder85c6a->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializerec77b && ($this->initializerec77b->__invoke($valueHolder85c6a, $this, 'getFilters', array(), $this->initializerec77b) || 1) && $this->valueHolder85c6a = $valueHolder85c6a;

        return $this->valueHolder85c6a->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializerec77b && ($this->initializerec77b->__invoke($valueHolder85c6a, $this, 'isFiltersStateClean', array(), $this->initializerec77b) || 1) && $this->valueHolder85c6a = $valueHolder85c6a;

        return $this->valueHolder85c6a->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializerec77b && ($this->initializerec77b->__invoke($valueHolder85c6a, $this, 'hasFilters', array(), $this->initializerec77b) || 1) && $this->valueHolder85c6a = $valueHolder85c6a;

        return $this->valueHolder85c6a->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializerec77b = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder85c6a) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder85c6a = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder85c6a->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializerec77b && ($this->initializerec77b->__invoke($valueHolder85c6a, $this, '__get', ['name' => $name], $this->initializerec77b) || 1) && $this->valueHolder85c6a = $valueHolder85c6a;

        if (isset(self::$publicProperties4cffe[$name])) {
            return $this->valueHolder85c6a->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder85c6a;
    ...
    {
        $this->initializerec77b && ($this->initializerec77b->__invoke($valueHolder85c6a, $this, '__set', array('name' => $name, 'value' => $value), $this->initializerec77b) || 1) && $this->valueHolder85c6a = $valueHolder85c6a;
    ...
    {
        $this->initializerec77b && ($this->initializerec77b->__invoke($valueHolder85c6a, $this, '__isset', array('name' => $name), $this->initializerec77b) || 1) && $this->valueHolder85c6a = $valueHolder85c6a;
    ...
    {
        $this->initializerec77b && ($this->initializerec77b->__invoke($valueHolder85c6a, $this, '__unset', array('name' => $name), $this->initializerec77b) || 1) && $this->valueHolder85c6a = $valueHolder85c6a;
    ...
    {
        $this->initializerec77b && ($this->initializerec77b->__invoke($valueHolder85c6a, $this, '__clone', array(), $this->initializerec77b) || 1) && $this->valueHolder85c6a = $valueHolder85c6a;

        $this->valueHolder85c6a = clone $this->valueHolder85c6a;
    }

    public function __sleep()
    {
        $this->initializerec77b && ($this->initializerec77b->__invoke($valueHolder85c6a, $this, '__sleep', array(), $this->initializerec77b) || 1) && $this->valueHolder85c6a = $valueHolder85c6a;

        return array('valueHolder85c6a');
    }
    ...
    {
        $this->initializerec77b = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializerec77b;
    }

    public function initializeProxy() : bool
    {
        return $this->initializerec77b && ($this->initializerec77b->__invoke($valueHolder85c6a, $this, 'initializeProxy', array(), $this->initializerec77b) || 1) && $this->valueHolder85c6a = $valueHolder85c6a;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder85c6a;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder85c6a;
    }
}
