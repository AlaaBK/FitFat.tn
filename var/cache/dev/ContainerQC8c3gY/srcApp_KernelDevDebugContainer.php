...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    /**
     * Gets the private '.service_locator.rVMUvVA' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_RVMUvVAService()
    {
     ...
     */
    protected function getAuthentificationAuthenticatorService()
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Security'.\DIRECTORY_SEPARATOR.'AuthentificationAuthenticator.php';
    ...
    protected function getSecurity_Authentication_Listener_Guard_MainService()
    {
        ...
        return $this->privates['security.authentication.listener.guard.main'] = new \Symfony\Component\Security\Guard\Firewall\GuardAuthenticationListener($a, ($this->privates['security.authentication.manager'] ?? $this->getSecurity_Authentication_ManagerService()), 'main', new RewindableGenerator(function () {
            yield 0 => ($this->privates['App\\Security\\AuthentificationAuthenticator'] ?? $this->getAuthentificationAuthenticatorService());
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder49ade = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializere2ea4 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicPropertiesbb50d = [
        
    ];

    public function getConnection()
    {
        $this->initializere2ea4 && ($this->initializere2ea4->__invoke($valueHolder49ade, $this, 'getConnection', array(), $this->initializere2ea4) || 1) && $this->valueHolder49ade = $valueHolder49ade;

        return $this->valueHolder49ade->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializere2ea4 && ($this->initializere2ea4->__invoke($valueHolder49ade, $this, 'getMetadataFactory', array(), $this->initializere2ea4) || 1) && $this->valueHolder49ade = $valueHolder49ade;

        return $this->valueHolder49ade->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializere2ea4 && ($this->initializere2ea4->__invoke($valueHolder49ade, $this, 'getExpressionBuilder', array(), $this->initializere2ea4) || 1) && $this->valueHolder49ade = $valueHolder49ade;

        return $this->valueHolder49ade->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializere2ea4 && ($this->initializere2ea4->__invoke($valueHolder49ade, $this, 'beginTransaction', array(), $this->initializere2ea4) || 1) && $this->valueHolder49ade = $valueHolder49ade;

        return $this->valueHolder49ade->beginTransaction();
    }

    public function getCache()
    {
        $this->initializere2ea4 && ($this->initializere2ea4->__invoke($valueHolder49ade, $this, 'getCache', array(), $this->initializere2ea4) || 1) && $this->valueHolder49ade = $valueHolder49ade;

        return $this->valueHolder49ade->getCache();
    }

    public function transactional($func)
    {
        $this->initializere2ea4 && ($this->initializere2ea4->__invoke($valueHolder49ade, $this, 'transactional', array('func' => $func), $this->initializere2ea4) || 1) && $this->valueHolder49ade = $valueHolder49ade;

        return $this->valueHolder49ade->transactional($func);
    }

    public function commit()
    {
        $this->initializere2ea4 && ($this->initializere2ea4->__invoke($valueHolder49ade, $this, 'commit', array(), $this->initializere2ea4) || 1) && $this->valueHolder49ade = $valueHolder49ade;

        return $this->valueHolder49ade->commit();
    }

    public function rollback()
    {
        $this->initializere2ea4 && ($this->initializere2ea4->__invoke($valueHolder49ade, $this, 'rollback', array(), $this->initializere2ea4) || 1) && $this->valueHolder49ade = $valueHolder49ade;

        return $this->valueHolder49ade->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializere2ea4 && ($this->initializere2ea4->__invoke($valueHolder49ade, $this, 'getClassMetadata', array('className' => $className), $this->initializere2ea4) || 1) && $this->valueHolder49ade = $valueHolder49ade;

        return $this->valueHolder49ade->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializere2ea4 && ($this->initializere2ea4->__invoke($valueHolder49ade, $this, 'createQuery', array('dql' => $dql), $this->initializere2ea4) || 1) && $this->valueHolder49ade = $valueHolder49ade;

        return $this->valueHolder49ade->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializere2ea4 && ($this->initializere2ea4->__invoke($valueHolder49ade, $this, 'createNamedQuery', array('name' => $name), $this->initializere2ea4) || 1) && $this->valueHolder49ade = $valueHolder49ade;

        return $this->valueHolder49ade->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializere2ea4 && ($this->initializere2ea4->__invoke($valueHolder49ade, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializere2ea4) || 1) && $this->valueHolder49ade = $valueHolder49ade;

        return $this->valueHolder49ade->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializere2ea4 && ($this->initializere2ea4->__invoke($valueHolder49ade, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializere2ea4) || 1) && $this->valueHolder49ade = $valueHolder49ade;

        return $this->valueHolder49ade->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializere2ea4 && ($this->initializere2ea4->__invoke($valueHolder49ade, $this, 'createQueryBuilder', array(), $this->initializere2ea4) || 1) && $this->valueHolder49ade = $valueHolder49ade;

        return $this->valueHolder49ade->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializere2ea4 && ($this->initializere2ea4->__invoke($valueHolder49ade, $this, 'flush', array('entity' => $entity), $this->initializere2ea4) || 1) && $this->valueHolder49ade = $valueHolder49ade;

        return $this->valueHolder49ade->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializere2ea4 && ($this->initializere2ea4->__invoke($valueHolder49ade, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializere2ea4) || 1) && $this->valueHolder49ade = $valueHolder49ade;

        return $this->valueHolder49ade->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializere2ea4 && ($this->initializere2ea4->__invoke($valueHolder49ade, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializere2ea4) || 1) && $this->valueHolder49ade = $valueHolder49ade;

        return $this->valueHolder49ade->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializere2ea4 && ($this->initializere2ea4->__invoke($valueHolder49ade, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializere2ea4) || 1) && $this->valueHolder49ade = $valueHolder49ade;

        return $this->valueHolder49ade->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializere2ea4 && ($this->initializere2ea4->__invoke($valueHolder49ade, $this, 'clear', array('entityName' => $entityName), $this->initializere2ea4) || 1) && $this->valueHolder49ade = $valueHolder49ade;

        return $this->valueHolder49ade->clear($entityName);
    }

    public function close()
    {
        $this->initializere2ea4 && ($this->initializere2ea4->__invoke($valueHolder49ade, $this, 'close', array(), $this->initializere2ea4) || 1) && $this->valueHolder49ade = $valueHolder49ade;

        return $this->valueHolder49ade->close();
    }

    public function persist($entity)
    {
        $this->initializere2ea4 && ($this->initializere2ea4->__invoke($valueHolder49ade, $this, 'persist', array('entity' => $entity), $this->initializere2ea4) || 1) && $this->valueHolder49ade = $valueHolder49ade;

        return $this->valueHolder49ade->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializere2ea4 && ($this->initializere2ea4->__invoke($valueHolder49ade, $this, 'remove', array('entity' => $entity), $this->initializere2ea4) || 1) && $this->valueHolder49ade = $valueHolder49ade;

        return $this->valueHolder49ade->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializere2ea4 && ($this->initializere2ea4->__invoke($valueHolder49ade, $this, 'refresh', array('entity' => $entity), $this->initializere2ea4) || 1) && $this->valueHolder49ade = $valueHolder49ade;

        return $this->valueHolder49ade->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializere2ea4 && ($this->initializere2ea4->__invoke($valueHolder49ade, $this, 'detach', array('entity' => $entity), $this->initializere2ea4) || 1) && $this->valueHolder49ade = $valueHolder49ade;

        return $this->valueHolder49ade->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializere2ea4 && ($this->initializere2ea4->__invoke($valueHolder49ade, $this, 'merge', array('entity' => $entity), $this->initializere2ea4) || 1) && $this->valueHolder49ade = $valueHolder49ade;

        return $this->valueHolder49ade->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializere2ea4 && ($this->initializere2ea4->__invoke($valueHolder49ade, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializere2ea4) || 1) && $this->valueHolder49ade = $valueHolder49ade;

        return $this->valueHolder49ade->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializere2ea4 && ($this->initializere2ea4->__invoke($valueHolder49ade, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializere2ea4) || 1) && $this->valueHolder49ade = $valueHolder49ade;

        return $this->valueHolder49ade->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializere2ea4 && ($this->initializere2ea4->__invoke($valueHolder49ade, $this, 'getRepository', array('entityName' => $entityName), $this->initializere2ea4) || 1) && $this->valueHolder49ade = $valueHolder49ade;

        return $this->valueHolder49ade->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializere2ea4 && ($this->initializere2ea4->__invoke($valueHolder49ade, $this, 'contains', array('entity' => $entity), $this->initializere2ea4) || 1) && $this->valueHolder49ade = $valueHolder49ade;

        return $this->valueHolder49ade->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializere2ea4 && ($this->initializere2ea4->__invoke($valueHolder49ade, $this, 'getEventManager', array(), $this->initializere2ea4) || 1) && $this->valueHolder49ade = $valueHolder49ade;

        return $this->valueHolder49ade->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializere2ea4 && ($this->initializere2ea4->__invoke($valueHolder49ade, $this, 'getConfiguration', array(), $this->initializere2ea4) || 1) && $this->valueHolder49ade = $valueHolder49ade;

        return $this->valueHolder49ade->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializere2ea4 && ($this->initializere2ea4->__invoke($valueHolder49ade, $this, 'isOpen', array(), $this->initializere2ea4) || 1) && $this->valueHolder49ade = $valueHolder49ade;

        return $this->valueHolder49ade->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializere2ea4 && ($this->initializere2ea4->__invoke($valueHolder49ade, $this, 'getUnitOfWork', array(), $this->initializere2ea4) || 1) && $this->valueHolder49ade = $valueHolder49ade;

        return $this->valueHolder49ade->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializere2ea4 && ($this->initializere2ea4->__invoke($valueHolder49ade, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializere2ea4) || 1) && $this->valueHolder49ade = $valueHolder49ade;

        return $this->valueHolder49ade->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializere2ea4 && ($this->initializere2ea4->__invoke($valueHolder49ade, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializere2ea4) || 1) && $this->valueHolder49ade = $valueHolder49ade;

        return $this->valueHolder49ade->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializere2ea4 && ($this->initializere2ea4->__invoke($valueHolder49ade, $this, 'getProxyFactory', array(), $this->initializere2ea4) || 1) && $this->valueHolder49ade = $valueHolder49ade;

        return $this->valueHolder49ade->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializere2ea4 && ($this->initializere2ea4->__invoke($valueHolder49ade, $this, 'initializeObject', array('obj' => $obj), $this->initializere2ea4) || 1) && $this->valueHolder49ade = $valueHolder49ade;

        return $this->valueHolder49ade->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializere2ea4 && ($this->initializere2ea4->__invoke($valueHolder49ade, $this, 'getFilters', array(), $this->initializere2ea4) || 1) && $this->valueHolder49ade = $valueHolder49ade;

        return $this->valueHolder49ade->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializere2ea4 && ($this->initializere2ea4->__invoke($valueHolder49ade, $this, 'isFiltersStateClean', array(), $this->initializere2ea4) || 1) && $this->valueHolder49ade = $valueHolder49ade;

        return $this->valueHolder49ade->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializere2ea4 && ($this->initializere2ea4->__invoke($valueHolder49ade, $this, 'hasFilters', array(), $this->initializere2ea4) || 1) && $this->valueHolder49ade = $valueHolder49ade;

        return $this->valueHolder49ade->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializere2ea4 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder49ade) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder49ade = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder49ade->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializere2ea4 && ($this->initializere2ea4->__invoke($valueHolder49ade, $this, '__get', ['name' => $name], $this->initializere2ea4) || 1) && $this->valueHolder49ade = $valueHolder49ade;

        if (isset(self::$publicPropertiesbb50d[$name])) {
            return $this->valueHolder49ade->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder49ade;
    ...
    {
        $this->initializere2ea4 && ($this->initializere2ea4->__invoke($valueHolder49ade, $this, '__set', array('name' => $name, 'value' => $value), $this->initializere2ea4) || 1) && $this->valueHolder49ade = $valueHolder49ade;
    ...
    {
        $this->initializere2ea4 && ($this->initializere2ea4->__invoke($valueHolder49ade, $this, '__isset', array('name' => $name), $this->initializere2ea4) || 1) && $this->valueHolder49ade = $valueHolder49ade;
    ...
    {
        $this->initializere2ea4 && ($this->initializere2ea4->__invoke($valueHolder49ade, $this, '__unset', array('name' => $name), $this->initializere2ea4) || 1) && $this->valueHolder49ade = $valueHolder49ade;
    ...
    {
        $this->initializere2ea4 && ($this->initializere2ea4->__invoke($valueHolder49ade, $this, '__clone', array(), $this->initializere2ea4) || 1) && $this->valueHolder49ade = $valueHolder49ade;

        $this->valueHolder49ade = clone $this->valueHolder49ade;
    }

    public function __sleep()
    {
        $this->initializere2ea4 && ($this->initializere2ea4->__invoke($valueHolder49ade, $this, '__sleep', array(), $this->initializere2ea4) || 1) && $this->valueHolder49ade = $valueHolder49ade;

        return array('valueHolder49ade');
    }
    ...
    {
        $this->initializere2ea4 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializere2ea4;
    }

    public function initializeProxy() : bool
    {
        return $this->initializere2ea4 && ($this->initializere2ea4->__invoke($valueHolder49ade, $this, 'initializeProxy', array(), $this->initializere2ea4) || 1) && $this->valueHolder49ade = $valueHolder49ade;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder49ade;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder49ade;
    }
}
